                  ...
                  <div class="col-md-6 col-lg-7 d-flex align-items-center">
                    <div class="card-body text-black">
                      ...
                      <form method="post" action="">
                        ...
                        <h5 class="fw-semibold mb-3 mt-3 pb-3" style="letter-spacing: 1px;">Créer un nouveau projet</h5>
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="datef" class="form-control" id="floatingInput" value="" placeholder="last" required>
